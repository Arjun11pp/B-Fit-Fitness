...
insert  into `attendance`(`attendance_id`,`user_id`,`date`,`check_in`,`check_out`) values (1,1,'13-2-2023','12:00','3:00'),(2,2,'13-2-2023','2:00','4:00'),(7,0,NULL,'10:00','11:00'),(8,0,NULL,'ljh','bvn'),(9,3,'2023-02-13','12:48:36','12:49:02'),(10,1,'2023-02-20','14:27:03','pending');
...
insert  into `bank`(`bank_id`,`bank_name`,`account_no`,`ifsc`,`balance`) values (1,'SBI','5455612','52524','4000'),(2,'FEDERAL','3265466','25461','500'),(3,'AXIS','2345432','565656','1000');
...
insert  into `employee`(`employee_id`,`employee_name`,`email_id`,`phone_no`,`dob`,`gender`,`experience`) values (1,'aswin shibu','aswin@gmail.com','64556131','19/6/2001','male','5'),(2,'naveen','naveen@gmail.com','546163','5/2/2002','male','6'),(3,'anandhu','dhdjjjfj','514344134','2023-02-07','Male','kjvkvkbkk'),(4,'albin mb','djdcjcjc','23456464','2023-02-03','Male','fguyf'),(5,'jyfj','bjgk','4354432','2023-02-02','Male','kgyjfkf');
...
insert  into `login`(`login_id`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'instructor','instructor','instructor'),(3,'user','user','user'),(4,'user','user','pending'),(6,'doctor','doctor','doctor'),(7,'physician','physician','physician'),(8,'doctor','doctor','doctor'),(10,'rferf','adarsh','pending'),(11,'adarsh','12345','doctor'),(12,'JSJJSX','1234','user'),(13,'athul','1234','user');
...
insert  into `user`(`user_id`,`name`,`email_id`,`phone_no`,`dob`,`gender`,`weight`,`height`,`bmi`) values (1,'s','df','g','h','h','45','148','45.0'),(3,'mb','evdwv','11635635','5135151','m','55','145','55.0'),(13,'athul','athul','56464446','625663','male','155','85','35.38');
