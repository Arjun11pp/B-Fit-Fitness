...
insert  into `allocate_user`(`allocation_id`,`user_id`,`batch_id`,`instructor_id`) values (1,1,1,2),(4,15,3,3),(5,19,1,1),(6,18,2,1),(7,17,2,2),(8,21,3,4),(9,13,2,6),(10,13,3,23),(11,14,2,23);
...
insert  into `attendance`(`attendance_id`,`user_id`,`date`,`check_in`,`check_out`) values (1,1,'13-2-2023','12:00','3:00'),(2,2,'13-2-2023','2:00','4:00'),(7,0,NULL,'10:00','11:00'),(8,0,NULL,'ljh','bvn'),(9,3,'2023-02-13','12:48:36','12:49:02'),(10,5,'2023-02-20','14:27:03','pending'),(11,1,'2023-02-25','19:29:03','pending'),(12,17,'2023-03-06','10:59:28','pending');
...
insert  into `bank`(`bank_id`,`bank_name`,`account_no`,`ifsc`,`balance`) values (1,'SBI','5455612','52524','11000'),(2,'FEDERAL','12345','123','500'),(3,'AXIS','123456','1234','50000');
...
insert  into `batches`(`batch_id`,`date_of_join`,`time_from`,`time_to`,`batch_name`) values (1,'2022','21/1/2022','25/1/2023','Morning'),(2,'2022','21/12/2022','21/1/2023','Evening'),(3,'2023','8/1/2002','5/8/2022','Afternnon'),(4,'2023-03-09','08:40','10:40','Evening'),(5,'2023-03-09','18:49','20:49','morning');
...
insert  into `booking`(`booking_id`,`user_id`,`physician_id`,`date`,`amount`,`status`) values (1,17,7,'2023-02-28','0','add_to_cart'),(2,17,8,'2023-02-28','0','add_to_cart'),(3,15,7,'2023-02-28','0','add_to_cart'),(4,15,8,'2023-02-28','0','add_to_cart'),(5,19,7,'2023-02-28','0','add_to_cart'),(6,3,7,'2023-03-06','0','add_to_cart');
...
insert  into `booking_sub`(`sub_id`,`booking_id`,`medicine_id`,`quantity`) values (2,1,1,'2'),(3,2,1,'3'),(4,3,1,'5'),(5,4,1,'10'),(6,5,1,'34'),(7,6,1,'25');
...
insert  into `competition`(`competition_id`,`competition_name`,`date`,`details`) values (1,'body building','12/2/2023','kannur'),(2,'deadlift','2023-03-01','kannur ');
...
insert  into `performer`(`performer_id`,`applicant_id`) values (1,1);
...
insert  into `stock`(`stock_id`,`physician_id`,`medicine_id`,`stock`) values (1,7,1,'75'),(2,8,1,'87');
